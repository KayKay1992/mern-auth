  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <img src={formData.profilePicture || currentUser.profilePicture} alt="profile" className="w-24 h-24 self-center cursor-pointer rounded-full object-cover mt-2"
        onClick={() => 
        ...
        <p className="text-sm self-center">{imageError ? (
          <span className="text-red-700">Error Uploading Image (file size must be less than 2mb)</span>) : imagePercent > 0 && imagePercent < 100 ? (
            <span className="text-gray-700">Image Uploading... {imagePercent}%</span>) : imagePercent === 100 ? (
